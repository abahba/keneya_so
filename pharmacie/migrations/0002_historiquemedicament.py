# Generated by Django 5.2.2 on 2025-07-09 06:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='HistoriqueMedicament',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(max_length=255)),
                ('date_action', models.DateTimeField(default=django.utils.timezone.now)),
                ('details', models.TextField(blank=True)),
                ('medicament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historiques', to='pharmacie.medicament')),
